                    ...
                    <Grid container spacing={0}>
                        ...
                        <Grid item xs={12} lg={12} sm container>
                            <Grid item xs container direction="column" spacing={2}>
                                <Grid item xs>
                                    <Typography className='text-itemDetail' gutterBottom variant="h5">{itemDetailDB.name}</Typography>
                                    <Typography className='text-itemDetail' variant="body2" gutterBottom>{itemDetailDB.description}</Typography>
                                    <Grid item>
